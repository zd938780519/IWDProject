...
public class NoticeView  extends FrameLayout implements View.OnClickListener {
    ...
    private final int DEFAULT_TEXT_COLOR = 0xffffffff;  // 默认字体颜色
    ...
    public NoticeView(Context context, AttributeSet attrs) {
        ...
        mTextColor = array.getColor(R.styleable.NoticeView_noticeTextSize, DEFAULT_TEXT_COLOR);
        mTextSize = array.getDimension(R.styleable.NoticeView_noticeTextColor, mTextSize);
        array.recycle();
